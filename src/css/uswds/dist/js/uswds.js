...
*/
    ...
    10: [
      ...
      { "../delegate": 12, "../delegateAll": 13, "object-assign": 9 }
    ],
    11: [
      function(require, module, exports) {
        "use strict";
    ...
    19: [
      function(require, module, exports) {
        ...
        var ACCORDION =
          "." + PREFIX + "-accordion, ." + PREFIX + "-accordion-bordered";
      ...
      function(require, module, exports) {
        ...
        module.exports = behavior(
          _defineProperty(
            {},
            CLICK,
            _defineProperty({}, HEADER + " [aria-controls]", toggleBanner)
          )
        );
      },
      { "../config": 28, "../events": 29, "../utils/behavior": 34 }
    ],
    21: [
      function(require, module, exports) {
        "use strict";
    ...
    24: [
      function(require, module, exports) {
        ...
        var LINK =
          "." + PREFIX + "-show_password, ." + PREFIX + "-show_multipassword";
        ...
        module.exports = behavior(
          _defineProperty({}, CLICK, _defineProperty({}, LINK, toggle))
        );
      },
      {
        "../config": 28,
    ...
    25: [
      function(require, module, exports) {
        ...
        var search = behavior(
          _defineProperty({}, CLICK, _defineProperty({}, BUTTON, showSearch)),
          {
    ...
    31: [
      ...
      { "./element-hidden": 30, "classlist-polyfill": 3 }
    ],
    32: [
      function(require, module, exports) {
        "use strict";
      ...
      { "./components": 22, "./config": 28, "./polyfills": 31, domready: 4 }
    ],
    33: [
      function(require, module, exports) {
        "use strict";
    ...
    34: [
      function(require, module, exports) {
        ...
        var sequence = function sequence() {
          for (
            var _len = arguments.length, seq = Array(_len), _key = 0;
            _key < _len;
            _key++
          ) {
      ...
      { "array-foreach": 2, "object-assign": 9, "receptor/behavior": 10 }
    ],
    35: [
      function(require, module, exports) {
        "use strict";
    ...
    39: [
      ...
      { "./toggle-field-mask": 38, "array-foreach": 2, "resolve-id-refs": 18 }
    ],
    40: [
      function(require, module, exports) {
        "use strict";
          ...
          Object.entries(data).forEach(function(_ref) {
            ...
            if (key.startsWith("validate")) {
              ...
              var validatorSelector =
                '[data-validator="' + validatorName + '"]';
              var validatorCheckbox = checkList.querySelector(
                validatorSelector
              );
