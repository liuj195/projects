...
dat.controllers.OptionController = (function(Controller, dom, common) {
  ...
  common.extend(
    ...
    {
      setValue: function(v) {
        var toReturn = OptionController.superclass.prototype.setValue.call(
          this,
          v
        );
...
dat.controllers.BooleanController = (function(Controller, dom, common) {
  ...
  common.extend(
    ...
    {
      setValue: function(v) {
        var toReturn = BooleanController.superclass.prototype.setValue.call(
          this,
          v
        );
        if (this.__onFinishChange) {
...
dat.GUI = dat.gui.GUI = (function(
  ...
  function augmentController(gui, li, controller) {
    ...
    if (controller instanceof NumberControllerSlider) {
      ...
      common.each(["updateDisplay", "onChange", "onFinishChange"], function(
        method
      ) {
